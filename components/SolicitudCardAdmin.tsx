...
const SolicitudCardAdmin: React.FC<SolicitudCardProps> = ({
    id,
    ...
    const navigateToSolicitudInfo = (solicitudId: number) => {
        router.push({
            pathname: "/informacionSolicitud/informacionSolicitudCompleta",
            params: { solicitudId: JSON.stringify(solicitudId) }
        })
    }
            ...
            <Card containerStyle={styles.card}>
                <View style={styles.content}>
                    <View style={styles.textContainer}>
                        ...
                        {nombreBarrio && <Text style={styles.subtitle}>Barrio: {nombreBarrio}</Text>}

                        {nombrePoste && <Text style={styles.subtitle}>Poste: {nombrePoste}</Text>}

                        {nombreAnimal && <Text style={styles.subtitle}>Animal suelto: {nombreAnimal}</Text>}

                        {nombreVecino && apellidoVecino &&
                            <Text style={styles.subtitle}>Vecino: {nombreVecino} {apellidoVecino}</Text>
                        }
...
export default SolicitudCardAdmin;
